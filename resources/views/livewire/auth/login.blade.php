<section class="bg-white dark:bg-dark-2 flex flex-wrap min-h-[100vh]">
    <div class="lg:w-1/2 lg:block hidden">
        <div class="flex items-center flex-col h-full justify-center">
            ...
            @endphp
            <img src="{{ $authBgLight ? asset('storage/' . $authBgLight) : asset('assets/images/auth/auth-img.png') }}" alt="" class="block dark:hidden">
            <img src="{{ $authBgDark ? asset('storage/' . $authBgDark) : asset('assets/images/auth/auth-img.png') }}" alt="" class="hidden dark:block">
        </div>
    </div>
        ...
        <div class="lg:max-w-[464px] mx-auto w-full">
            <div>
                <a href="{{ route('home') }}" class="mb-2.5 max-w-[290px]">
                    ...
                    @endphp
                    <img src="{{ $logoLight ? asset('storage/' . $logoLight) : asset('assets/images/logo.png') }}" alt="" class="block dark:hidden">
                    <img src="{{ $logoDark ? asset('storage/' . $logoDark) : asset('assets/images/logo-light.png') }}" alt="" class="hidden dark:block">
                </a>
