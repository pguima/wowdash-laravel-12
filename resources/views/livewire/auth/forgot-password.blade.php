            ...
            <div class="lg:max-w-[464px] mx-auto w-full">
                ...
                <form wire:submit.prevent="sendResetLink">
                    ...
                    <div class="text-center">
                        <a href="{{ route('login') }}" class="text-primary-600 font-bold mt-6 hover:underline">Back to
                            Sign In</a>
                    </div>
        ...
        <div class="relative p-10 w-full max-w-[496px] max-h-full rounded-2xl bg-white dark:bg-neutral-700">
            ...
            <div class="p-2.5 text-center">
                ...
                <div class="mt-8 text-sm">
                    <p class="mb-0">Don't receive an email? <a href="javascript:void(0)" wire:click="sendResetLink"
