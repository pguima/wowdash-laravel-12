...
<body class="dark:bg-neutral-800 bg-neutral-100 dark:text-white" x-data="{ 
    ...
    <main class="dashboard-main" :class="{ 'active': isSidebarActive }">
        ...
        <footer class="d-footer">
            <div class="flex items-center justify-between gap-3">
                <p class="mb-0">{{ __('© 2025 WowDash. All Rights Reserved.') }}</p>
                <p class="mb-0">{{ __('Made by') }} <span class="text-primary-600">{{ __('Pixcels Themes') }}</span></p>
            </div>
        </footer>
    </main>
