        ...
        <div class="lg:max-w-[464px] mx-auto w-full">
            ...
            <form wire:submit.prevent="register">
                <div class="icon-field mb-4 relative">
                    ...
                    @error('name') <span class="text-danger-600 text-sm mt-1 block">{{ $message }}</span> @enderror
                </div>
                <div class="icon-field mb-4 relative">
                    <span class="absolute start-4 top-1/2 -translate-y-1/2 pointer-events-none flex text-xl">
                ...
                <div class=" mt-6">
                    ...
                    @error('terms') <span class="text-danger-600 text-sm mt-1 block">{{ $message }}</span> @enderror
                </div>
                <button type="submit"
